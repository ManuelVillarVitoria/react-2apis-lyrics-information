# `Lyrics Search Engine and Artists Information`

_The project consists of doing the following:_

_1.-Creating the form and reading the information of State._

_2.-Making requests to 2 APIS's, for obtaining the results of the songs lyrics and the artists information._

_3.-Displaying the results of the APIS in the DOM._
